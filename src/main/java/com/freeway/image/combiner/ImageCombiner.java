...
public class ImageCombiner {
     ...
     * @return
     */
    public TextElement addTextElement(String text, String fontName, int style, int fontSize, int x, int y) {
        TextElement textElement = new TextElement(text, fontName, style, fontSize, x, y);
        this.combineElements.add(textElement);
        return textElement;
    }
