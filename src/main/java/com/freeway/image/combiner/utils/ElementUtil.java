package com.freeway.image.combiner.utils;
...
public class ElementUtil {
     ...
     * @return
     */
    public static int computeTextLineHeight(TextElement textElement) {
     ...
     * @return
     */
    public static int computeTextWidth(TextElement textElement) {
        TextPainter textPainter = new TextPainter();
