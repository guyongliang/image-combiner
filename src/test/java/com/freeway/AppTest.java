...
public class AppTest {
    ...
    public void FullTest() throws Exception {
        ...
        combiner.addTextElement(content, "微软雅黑", 0,40, 150, 1480)
        ...
        //动态计算位置
        int offsetPrice = textPrice.getX() + ElementUtil.computeTextWidth(textPrice) + 10;
    ...
    public void dynamicWidthDemoTest() throws Exception {
        ...
        offsetX += ElementUtil.computeTextWidth(element1);
    ...
    public void breakLineTest() throws Exception {
        ...
        combiner.addTextElement("测试换行时的文字效果，每行是不是都一样，我们开始吧", font, 100, 200)
                .setColor(Color.red)
                .setCenter(true)
                .setStrikeThrough(true)
                .setAutoBreakLine(630, 2, 70);

        combiner.addRectangleElement(100, 200, 300, 300)
                .setRoundCorner(100)
                .setColor(Color.red);
        //合成图片
        combiner.combine();
     ...
     */
    @Test
    public void ymxk() throws Exception {
        ...
        int contentHeight = ElementUtil.computeTextLineHeight(tempElement);
        ...
        combiner.addTextElement("苏轼的早餐", "微软雅黑", 0, 16, 60, 290);
